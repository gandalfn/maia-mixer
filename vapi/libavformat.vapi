namespace Av.Format
{
    ...
    [Flags, (cname = "int", cprefix = "AVFMT_", cheader_filename = "avformat.h")]
    public Flag
    {
        NOFILE,
        NEEDNUMBER,
    ...
    [Compact, CCode (cname = "AVInputFormat", cheader_filename = "avformat.h")]
    ...
    [Compact, CCode (cname = "AVOutputFormat", cheader_filename = "avformat.h")]
    ...
    [CCode (cname = "int", cprefix = "AV_DISPOSITION_", cheader_filename = "avformat.h")]
    ...
    [Compact, CCode (cname = "AVStream", cheader_filename = "avformat.h")]
    public class Stream
    {
    ...
    [Compact, CCode (cname = "AVProgram", cheader_filename = "avformat.h")]
    ...
    [Compact, CCode (cname = "AVChapter", cheader_filename = "avformat.h")]
    ...
    [CCode (cname = "AVDurationEstimationMethod", cprefix = "AVFMT_DURATION_FROM_", cheader_filename = "avformat.h")]
    ...
    [Compact, CCode (cname = "AVFormatInternal", cheader_filename = "avformat.h", cheader_filename = "avformat.h")]
    public class Internal
    {
    }

    [Compact, CCode (cname = "AVFormatContext", cheader_filename = "avformat.h", free_function = "avformat_free_context", cheader_filename = "avformat.h")]
    public class Context
    {
        ...
        public static int open_input(ref Context? context, string url, InputFormat? fmt, out Util.Dictionary? options);
        ...
        public int find_best_stream(Media.Type type, int wanted_stream_nb, int related_stream, out Codec? decoder_ret, int flags);
    }
}
